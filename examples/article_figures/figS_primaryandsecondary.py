...
capsid_primary_smlm = metrics.zoom_img(image_outputs1["SMLM"][0], zoom_in=zoom)
...
capsid_primary_secondary_smlm = metrics.zoom_img(image_outputs2["SMLM"][0], zoom_in=zoom)
