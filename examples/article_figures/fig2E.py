...
ax.imshow(image_outputs1["SMLM"][0], cmap="grey")
...
ax = fig.add_subplot(122)
ax.imshow(image_outputs2["SMLM"][0], cmap="grey")
...
ax = fig.add_subplot(122)
ax.imshow(image_outputs3["SMLM"][0], cmap="grey")
...
ax = fig.add_subplot(122)
ax.imshow(image_outputs4["SMLM"][0], cmap="grey")
