...
myexp.coordinate_field.molecules[0].gen_axis_plot(axis_object=ax2, emitter_plotsize=1, view_init=[90,0,0])
...
myexp.coordinate_field.molecules[0].gen_axis_plot(axis_object=ax4, emitter_plotsize=1, view_init=[90,0,0])
#### 
...
myexp.coordinate_field.molecules[0].gen_axis_plot(axis_object=ax6, emitter_plotsize=1, view_init=[90,0,0])
plt.tight_layout()
