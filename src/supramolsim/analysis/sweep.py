...
def analyse_sweep_single_reference(img_outputs, img_params, reference_image, reference_params, zoom_in=0, metric:list =["ssim",], **kwargs):
    measurement_vectors = []
    # ref_pixelsize = analysis_case_params["ref_pixelsize"]
    inputs = dict()
    for params_id in img_params.keys():
        ...
        for img_r in img_outputs[params_id]:
            ...
            rep_number += 1
    return measurement_vectors, inputs, metric
