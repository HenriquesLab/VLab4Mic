...
def format_coordinates(coords, plotsize=1, plotalpha=1, plotmarker="o", plotcolour="k", name="", **kwargs):
    formatted = {
                "coordinates": coords,
                "plotsize": plotsize,
                "plotalpha": plotalpha,
...
def set_colorplot(plotting_params):
    ...
    if len(plotting_params) == 0:
        ...
        CB_color_cycle = ['#377eb8', '#ff7f00', '#4daf4a',  # https://gist.github.com/thriveth/8560036
